...
function configureHeader(basePath) {
    ...
    const links = {
        ...
        'news-link': `${basePath}pages/news`,
        'docs-link': 'https://docs.ngkore.org',
...
function setActiveLink() {
    ...
    links.forEach(link => {
        ...
        if (linkPath) {
            ...
            if (currentPath.endsWith('/') && (linkPath === '/' || linkPath.includes('index'))) {
                link.classList.add('active');
            } else if (currentPath.includes(linkPath.replace('../', ''))) {
                link.classList.add('active');
            } else if (currentPath === '/' && (linkPath === '/' || linkPath.includes('index'))) {
                link.classList.add('active');
            }
        }
    });
